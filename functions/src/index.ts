...
import {firestoreUsersPiecesOnDelete} from './firestore/users_pieces/onDelete';
...
export const firestoreUsersPiecesOnDeleteF = usersPiecesDocument.onDelete(firestoreUsersPiecesOnDelete);
