...
describe('ToolbarComponent', () => {
  ...
  it('should display toolbar-background-low.jpg as background image by default', () => {
    ...
    expect(typeof component.image).not.toBe('string');
    // @ts-ignore
    expect(component.image.low).toContain('toolbar-background-low.jpg');
    // @ts-ignore
    expect(component.image.normal).toContain('toolbar-background.jpg');
  });
